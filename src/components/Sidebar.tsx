  ...
  return (
    <div className="fixed left-0 top-0 h-full w-64 bg-gradient-to-b from-slate-900 via-slate-800 to-slate-900 shadow-2xl z-50">
      ...
      <div className="absolute bottom-6 left-4 right-4">
        <div onMouseEnter={()=>setShowLogOut(true)} onMouseLeave={()=>setShowLogOut(false)} className="bg-slate-800/50 backdrop-blur-sm rounded-lg p-4 border border-slate-700">
          <div className="flex items-center space-x-3">
            ...
            <div>
              ...
              {
                showlogout && ( 
                <div  onClick={handleLogout} className="text-red-600 cursor-pointer text-sm">
                  Logout
